...
export const Info = Schema.Union([
  ...
  Schema.Struct({
    ...
    // Dispatch: human-readable description of what the agent is currently doing
    // (e.g. "Thinking...", "Bash pwd"), surfaced on the agent dashboard.
    activity: optional(Schema.String),
  }),
