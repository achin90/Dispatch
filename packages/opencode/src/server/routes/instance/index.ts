...
export const InstanceRoutes = (upgrade: UpgradeWebSocket, opts?: CorsOptions): Hono => {
  ...
  if (Flag.OPENCODE_EXPERIMENTAL_HTTPAPI) {
    ...
    app.get(ExperimentalPaths.gitRepos, (c) => handler(c.req.raw, context))
    app.get(ExperimentalPaths.githubStatus, (c) => handler(c.req.raw, context))
    app.get(ExperimentalPaths.githubPr, (c) => handler(c.req.raw, context))
    app.post(ExperimentalPaths.githubPr, (c) => handler(c.req.raw, context))
    app.post(ExperimentalPaths.githubPrMerge, (c) => handler(c.req.raw, context))
    app.get(ExperimentalPaths.worktreeInfo, (c) => handler(c.req.raw, context))
    app.get(ExperimentalPaths.worktreeDiff, (c) => handler(c.req.raw, context))
    app.get(ExperimentalPaths.worktreeDiffstat, (c) => handler(c.req.raw, context))
    ...
    app.post(McpPaths.health, (c) => handler(c.req.raw, context))
    ...
    app.get(SessionPaths.lastResponse, (c) => handler(c.req.raw, context))
