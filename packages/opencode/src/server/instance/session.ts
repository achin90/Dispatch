  ...
  new Hono()
    ...
    .post(
      ...
      async (c) => {
        const sessionID = c.req.valid("param").sessionID
        const body = c.req.valid("json")
        await withSessionDirectory(sessionID, () =>
    ...
    .delete(
      ...
      async (c) => {
        const params = c.req.valid("param")
        await withSessionDirectory(params.sessionID, () =>
          AppRuntime.runPromise(
            Effect.gen(function* () {
    ...
    .post(
      ...
      async (c) => {
        ...
        return stream(c, async (stream) => {
          ...
          try {
            const msg = await withSessionDirectory(sessionID, () =>
    ...
    .post(
      ...
      async (c) => {
        ...
        const body = c.req.valid("json")
        const msg = await withSessionDirectory(sessionID, () =>
          AppRuntime.runPromise(SessionPrompt.Service.use((svc) => svc.command({ ...body, sessionID }))),
        )
        return c.json(msg)
      },
    )
    .post(
      ...
      async (c) => {
        ...
        const body = c.req.valid("json")
        const msg = await withSessionDirectory(sessionID, () =>
          AppRuntime.runPromise(SessionPrompt.Service.use((svc) => svc.shell({ ...body, sessionID }))),
        )
        return c.json(msg)
      },
    )
