...
function ToolPart(props: { last: boolean; part: ToolPart; message: AssistantMessage }) {
  ...
  return (
    <Show when={!shouldHide()}>
      <Switch>
        {/* Claude SDK emits `bash`; its input shape matches upstream's Shell renderer */}
        <Match when={props.part.tool === ShellID.ToolID || normalizedTool() === "bash"}>
          <Shell {...toolprops} />
        </Match>
        ...
        <Match when={normalizedTool() === "codesearch" || normalizedTool() === "code"}>
